...
function lg_setup_theme(){
	...
	// Image Sizes
	add_image_size( 'lg-post-image', 860, 575, false );
	...
	$starter_content                =   array(
		...
		'theme_mods'                => array(
			'lg_facebook_handle'    =>  'udemy',
			'lg_twitter_handle'     =>  'udemy',
			'lg_instagram_handle'   =>  'udemy',
			'lg_email'              =>  'udemy',
			'lg_phone_number'       =>  'udemy',
			'lg_header_show_search' =>  'yes',
			'lg_header_show_cart'   =>  'yes',
		),
